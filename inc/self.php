...
if (@$_FILES) {
	...
	if (mb_eregi('image/?jpeg', $_FILES['photofile']['type'])) {
...
", $chars["about"]);
	...
	SQL::q("UPDATE chars SET about='" . $chars["about"] . "' WHERE uid=" . UID);
}
?>
			...
			<table style="width: 100%">
				...
				<tr>
					<td align=center>
						<form method=post>
							<?
							if (!SQL::qCount("SELECT COUNT(*) FROM chars WHERE uid='" . $pers["uid"] . "'")) {

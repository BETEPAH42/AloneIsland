...
if (@$_GET["edit"] and empty($_POST)) {
	$new = sql::q1("SELECT * FROM news WHERE date='" . $_GET["edit"] . "'");
...
<?
if (@$_POST["ntitle"]) {
	if (SQL::q("INSERT INTO `news` ( `date` , `title` , `text` ) 
VALUES (

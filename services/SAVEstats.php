<script>
	...
	if (@$_POST["stats"] and !$pers["cfight"]) {
		...
		if ($stats == $stats2 and $y == 0) {
			...
			if ($pers["s1"] < $pers["s6"])
				$fstate = 3;
			sql::q("UPDATE `users` SET " . $str . "`s1`='" . $pers["s1"] . "' ,`s2`='" . $pers["s2"] . "' ,`s3`='" . $pers["s3"] . "' ,`s4`='" . $pers["s4"] . "' ,`s5`='" . $pers["s5"] . "' , `free_stats`='" . $pers["free_stats"] . "' ,`ma`='" . $pers["ma"] . "' ,`hp`='" . $pers["hp"] . "' , `s6`='" . $pers["s6"] . "',`kb`='" . $pers["kb"] . "', fstate=" . $fstate . " WHERE `uid` = " . $pers["uid"] . "");
		}
	}

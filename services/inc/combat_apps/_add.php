...
if (@$_POST["travm"] and $cat == 1 and !$pers["apps_id"]) {
	...
	$id = sql::qi("INSERT INTO `app_for_fight` (`uid` , `oruj` , `travm` , `timeout` , `atime` , `count1` , `count2` , `minlvl1` , `minlvl2` , `maxlvl1` , `maxlvl2` , `pl1` , `pl2` , `comment` , `type` ,`bplace`) VALUES (" . $pers["uid"] . ", " . $c2 . ", " . $c1 . ", " . $c3 . ", " . (time() + 300) . ", 1, 0, " . $pers["level"] . ", 0, 0, 0, 1, 0, '" . $c4 . "', 1 ," . $bplace . ");");
	$pers["apps_id"] = $id;
...
if (@$_POST["travm"] and $cat == 2 and !$pers["apps_id"]) {
	...
	$id = sql::qi("INSERT INTO `app_for_fight` (`uid` , `oruj` , `travm` , `timeout` , `atime` , `count1` , `count2` , `minlvl1` , `minlvl2` , `maxlvl1` , `maxlvl2` , `pl1` , `pl2` , `comment` , `type` ,`bplace`) VALUES (" . $pers["uid"] . ", " . $c2 . ", " . $c1 . ", " . $c3 . ", " . (time() + $c11) . ", " . $c5 . ", " . $c6 . ", " . $c7 . ", " . $c8 . ", " . $c9 . ", " . $c10 . ", 1, 0, '" . $c4 . "', 2, " . $bplace . ");");
	$pers["apps_id"] = $id;
	set_vars("apps_id=" . $id . ",fteam=1", $pers["uid"]);
	echo "da('Заявка удачно подана!<br>');";
}
...
if (@$_POST["travm"] and $cat == 3 and !$pers["apps_id"]) {
	...
	$id - sql::qi("INSERT INTO `app_for_fight` (`uid` , `oruj` , `travm` , `timeout` , `atime` , `count1` , `minlvl1` , `maxlvl1` , `pl1` , `comment` , `type` ,`bplace`) VALUES (" . $pers["uid"] . ", " . $c2 . ", " . $c1 . ", " . $c3 . ", " . (time() + $c11) . ", " . $c5 . ", " . $c7 . ", " . $c9 . ", 1, '" . $c4 . "', 3 , " . $bplace . ");");
	$pers["apps_id"] = $id;
	set_vars("apps_id=" . $id . ",fteam=1", $pers["uid"]);
	echo "da('Заявка удачно подана!<br>');";
}

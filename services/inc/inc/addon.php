...
if ($_GET["into_book"] and $book["slots"]) {
	...
	$book["slots"]--;
	sql::q("UPDATE wp SET slots=slots-1,`index`='" . $book["index"] . "' WHERE id=" . $book["id"] . "");
}
if ($_GET["out_book"]) {
			...
			<table border="0" width="100%" cellpadding="0">
				<tr>
					<td width="130" valign="top">
						<form name=sort method=get><select size="1" name="filter_f1" class="fightlong" onchange="document.sort.submit();">
					...
					<td width="152">
						<input type="button" value="Обновить" class="loc" onclick="location='main.php?zinfo=full'">
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td valign="top">
			...
			<table border="0" width=437 cellspacing="0" cellpadding="0" class="laar" style="border-width: 0">
				<tr>
					<td align="center">
						<input type=button class=loc onclick="location='main.php?filter_f3=blast'" value='Магические удары' style="width: 100">
					</td>
		...
		<td>
			...
			if ($pers["cfight"] == 0) {
				...
				echo "<font class=hp>Нельзя использовать магию, находясь в бою или в заявке.</font>";
			}

...
$_sp3 = "Просто удары в спину(<font color=red>Отключено</font>)";
$_sp4 = "Шарим по карманам мобов и персов :-)";
$_sp6 = "Данный навык полезен для профессии <b>Рыбак</b>.";
...
<tr >
<td width="70%" onmouseover="s_des(event,'|<b><?=$_sp3;?></b>')" onmouseout='h_des()' onmousemove=move_alt(event)><?=$nworked.name_of_skill("sp3");?></td>
<td width="30%" align=right><div id=m3></div></td>
</tr><tr>
<td width="70%" onmouseover="s_des(event,'|<b><?=$_sp4;?></b>')" onmouseout='h_des()' onmousemove=move_alt(event)><?=$worked.name_of_skill("sp4");?></td>
<td width="30%" align=right><div id=m4></div></td>
</tr><tr >
<td width="70%"><?=$worked.name_of_skill("sp5");?></td>
<td width="30%" align=right><div id=m5></div></td>
</tr><tr>
<td width="70%" onmouseover="s_des(event,'|<b><?=$_sp6;?></b>')" onmouseout='h_des()' onmousemove=move_alt(event)><?=$worked.name_of_skill("sp6");?></td>

...
if ($qWitch["finished"] && $qWitch["time"] < tme()) {
	...
	say_to_chat("o", "Ведьма Алиса снова просит обитателей Метрополиса помочь ей в готовке нового термоядерного зелья. На этот раз ей нужно <b>«" . $randWp . "»</b>. И как обычно она благодарит за помощь щедрыми подарками!", 0, '', '*', 0);

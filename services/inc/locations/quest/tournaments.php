...
{
	sql::q("UPDATE quest SET finished=0,time=" . tme() . ",type=0 WHERE id = " . TOUR1);
...
{
	sql::q("UPDATE quest SET finished=0,time=" . tme() . ",type=0 WHERE id = " . TOUR2);
...
{
	sql::q("UPDATE quest SET finished=0,time=" . tme() . ",type=0 WHERE id = " . TOUR3);

...
$("#center").css({left:'30%',top:'100',width:'450px',height:'200px'});
	...
	if(_sort=='price') 
	 ...
	 text += '</form>';
	 $("#center").html(sbox('123<table style="width: 100%"><tr><td class=ma>Настройки инвентаря</td> <td style="height: 30px; width: 30px;cursor:pointer;" onclick="inv_conf()" title=Close><img src="images/closebox.png" width="30" height="30" ></td></tr><tr><td colspan=3 class=combofight>'+text+'</td></tr></table>'));
	 }
	else
	{
	 //$("#center2").fadeOut(500);
...
var all_link = '';
if(_type=='herbal' || _type=='ruda' || _type=='trees' || _type=='fish' || _type=='skin')
	all_link = '<center><a href=main.php?filter_f4=all class=nt>Весь инвентарь</a></center>';


if(_herbal+_ruda+_trees+_fish+_skin)
$("#container1").html("<table border=0 width=100% ><tr><td align=center onclick=\"location='main.php?filter_f4=herbal'\" style='cursor:pointer;'><img src=images/gameplay/shop_icons/travy.png><div class=gray>Травы["+_herbal+"]</div></td><td align=center onclick=\"location='main.php?filter_f4=ruda'\" style='cursor:pointer;'><img src=images/gameplay/shop_icons/resources.png><div class=gray>Руда["+_ruda+"]</div></td><td align=center onclick=\"location='main.php?filter_f4=trees'\" style='cursor:pointer;'><img src=images/gameplay/shop_icons/instruments.png><div class=gray>Древисина["+_trees+"]</div></td><td align=center onclick=\"location='main.php?filter_f4=fish'\" style='cursor:pointer;'><img src=images/gameplay/shop_icons/fish.png><div class=gray>Рыба["+_fish+"]</div></td><td align=center onclick=\"location='main.php?filter_f4=skin'\" style='cursor:pointer;'><img src=images/gameplay/shop_icons/travy.png><div class=gray>Шкуры["+_skin+"]</div></td></tr></table>"+all_link);
else 

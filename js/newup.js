...
function show_head(curstate, fourthname, code, apps, trvm, help) {
	...
	if (curstate != 4) {
		...
		if (curstate == 1 || apps)
			...
			inv = 'src="images/DS/tbuttons_2.png" onclick="top.frames[\'main_top\'].location=\'main.php?go=inv\'" onmouseout="this.src=\'images/DS/tbuttons_2.png\'" onmouseover="this.src=\'images/DS/tbuttons_2_hover.png\'" style="position:relative;z-index:1501;top:-10px;cursor:pointer;"';
		...
		d.write("<div id=_top style='width:100%; height:18px; background-image:url(\"/images/DS/main_topline.jpg\");'></div>");


		document.onscroll = function () {
			if (document.body.scrollTop > 50) top.hide_logo();
			if (document.body.scrollTop <= 50) top.show_logo();
		}

		top.show_logo();
		document.body.offscroll = BodyScroll;
		document.offscroll = BodyScroll;
	}
	else
		top.hide_logo();

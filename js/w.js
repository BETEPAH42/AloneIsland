...
else if (art==2 && present=='') text +=  ('<br><font class=hp>Не подписанно</font>');
else if (art==1 && present!='') text +=  ('<br><img src=images/art.gif>Подарок от <b>'+present+'</b>');
else if (art==2 && present!='') text +=  ('<br>Подписанно <b><font class=hp>'+present+'</font></b>');
text +=  (attr);

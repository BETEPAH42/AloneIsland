...
function init_main_layer()
{
	...
	ml.style.top = document.body.scrollTop+60;
	ml.innerHTML = 'РЕДАКТОР ВЕЩЕЙ [Aloneislands] <a href=javascript:disable_main_layer() class=timef><b>[УБРАТЬ]</b></a><hr>';
}

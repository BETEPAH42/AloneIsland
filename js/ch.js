...
function edit_msg(t, server_state, h, m, s) {
	...
	for (i = 0; i < t.length; i++) {
		...
		if (txt[6] != 3) {
			...
			if (txt[1] == 'f') {
				s += '<font class=user style="color:#990000">Что-то связано с профессией рыбак (Г«Г Г±ГЄГ®ГўГ®, Г·ГІГ®ГЎ Г°Г»ГЎГі Г­ГҐ Г°Г Г±ГЇГіГЈГ ГІГј)</font> ' + txt[3] + '<br>';
				att = 1;
			}
			if (txt[1] == 'f1') {
				s += '<font class=user style="color:#990000">Рыбак:</font> ' + txt[3] + '<br>';
				att = 1;
			}
			if (txt[1] == 'ft') {
				s += '<font class=user style="color:#990000">Турнир рыбаков::</font> ' + txt[3] + '<br>';
				att = 1;
			}
			if (txt[1] == 'gl') {
				s += '<font class=al>Глава клана:</font> ' + txt[3] + '<br>';
				att = 1;
			}
			if (txt[1] == 'd') {
				s += '<font class=user style="color:green">Дровосек:</font> ' + txt[3] + '<br>';
				att = 1;
			}
			if (txt[1] == 'o') {
				s += '<font class=user style="color:#990000">Квест:</font> ' + txt[3] + '<br>';
				att = 1;
			}
			//ГЄГ Г°ГІГЁГ­ГЄГЁ Г°Г ГЎГ®ГІГ ГѕГІ Гў Г·Г ГІГҐ тоже непонятно что это
			if (txt[1] == 'k') {
				s += '<img src=images/signs/c001.gif>ГЄГўГў.</font> ' + txt[3] + '<br>';
				att = 1;
			}
			if (att == 0) {

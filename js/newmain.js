...
function index(terror)
{
	...
	var links = '<a class="boxed" href="reg.php" title="Регистрация на AloneIslands" rel="{handler:\'iframe\',size:{x:500,y:450}}" class=Main style="color: #000000">Регистрация</a> | <a class="boxed" href="remind.php" title="Форум" rel="{handler:\'iframe\',size:{x:'+(sw-150)+',y:200}}" class=Main style="color: #000000">Забыли пароль?</a>';

...
function changeChatOrientation(t) {
	...
	if (top.frames['ch_buttons'].document.querySelector('input[name="message"]'))
		top.frames['ch_buttons'].document.querySelector('input[name="message"]').value = '';
	if (top.frames['ch_buttons'].document.querySelector('input[name="type"]'))
		top.frames['ch_buttons'].document.querySelector('input[name="type"]').value = t;
	top.chat_turn = t;
	top.add_msg('', 0, t);

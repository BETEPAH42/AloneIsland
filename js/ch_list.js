...
function hero_string(element, hr) {
	...
	var inviz = '';
	var uninviz = '';
	if (arr[0].indexOf('n=') > -1) { arr[0] = arr[0].replace('n=', ''); inviz = '<i>'; uninviz = '</i>'; }
